...
def evaluar(expresion_infija, tamaño, expresion_postfija):
    expresion_postfija = convertir(expresion_infija, tamaño, expresion_postfija)
...
def convertir(expresion_infija, tamaño, expresion_posfija):
    metodos = Metodos(tamaño, expresion_posfija)
